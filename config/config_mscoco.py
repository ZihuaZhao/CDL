...
# DATASET PARAMETERS
parser.add_argument("--data_name", type=str, default="mscoco")
...
parser.add_argument('--warmup_epochs', type=int, default=30) # 20
parser.add_argument('--e_epoch1', type=int, default=10) # 10
parser.add_argument('--e_epoch2', type=int, default=10) # 10
parser.add_argument('--warmup_ms', type=list, default=[10, 20])
parser.add_argument('--warmup_lr1', type=float, default=5e-5) # 5e-5
...
### TRAIN PARAMETERS
parser.add_argument('--train_epochs', type=int, default=200) # 20
parser.add_argument('--train_ms', type=list, default=[50, 100]) # 30, 50
...
parser.add_argument('--weight_epoch', type=int, default=20)
...
# NOISE PARAMETERS
parser.add_argument('--use_noise_file', type=bool, default=True)
parser.add_argument('--clean_label', type=bool, default=False)
parser.add_argument('--noise_mode', type=str, default='asym')
parser.add_argument('--r_label', type=float, default=0)
parser.add_argument('--r_corr', type=float, default=0.5)
...
# RUNNING PARAMETERS
parser.add_argument('--gpu_ids', type=list, default=[0]) # Use data parallel when including MULTIPLE gpu_ids and set the first as the MAIN gpu
