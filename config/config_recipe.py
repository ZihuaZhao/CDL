...
# DATASET PARAMETERS
parser.add_argument("--data_name", type=str, default="recipe")
parser.add_argument('--data_dir', type=str, default='/path/to/data')
parser.add_argument('--data_scale', type=str, default='toy_10') # origin, toy_10, toy_50, toy_100
...
# RUNNING PARAMETERS
parser.add_argument('--gpu_ids', type=list, default=[2]) # Use data parallel when including MULTIPLE gpu_ids and set the first as the MAIN gpu
